...
No-Limit Texas Hold'em table engine, buy-in/cash-out, HTTP + WebSocket (`@vr-poker/netcode`) + **casino-server Socket.IO RPC**. Default table id: `holdem3`. See [docs/casino-server.md](../../docs/casino-server.md).
...
- [x] casino-server Socket.IO RPC gateway (same port as HTTP)
